...
/**
 * @ClassName SearchHzGGZYUtil
 * @Desc
 * @Author wh
 * @Date 2020/10/20
 */
public class SearchHzGGZYUtil {

    static String GGZY_Hz_ROOT_URL = "http://www.hzsggzyjyzx.gov.cn/";
    static String GGZY_Hz_URL = "http://www.hzsggzyjyzx.gov.cn/inteligentsearch/rest/inteligentSearch/getFullTextData";

    static String data = "{\"token\":\"\",\"pn\":pn_param,\"rn\":10,\"sdt\":\"\",\"edt\":\"\",\"wd\":\"search_param\",\"inc_wd\":\"\"," +
            "\"exc_wd\":\"\",\"fields\":\"title;content\",\"cnum\":\"\",\"sort\":\"{\\\"webdate\\\":0}\",\"ssort\":\"title\"," +
            "\"cl\":500,\"terminal\":\"\",\"condition\":null,\"time\":null,\"highlights\":\"title;content\",\"statistics\":null," +
            "\"unionCondition\":null,\"accuracy\":\"\",\"noParticiple\":\"1\",\"searchRange\":null}";

    public static LinkedHashMap<String, List<String>> searchHZGGZYLoop(int bidType, Map<String, List<String>> resultMap){
        ...
        Arrays.stream(Constants.params).forEach(str -> {
            ...
            try {
                ...
                while (flag){
                    ...
                    String post = DataCamling.postWithRequest(GGZY_Hz_URL, tempData);
                    ...
                    for (Object obj :records) {
                        ...
                        linkurl = GGZY_Hz_ROOT_URL + linkurl;
    ...
    public static List<BidModel> searchHZGGZYDetail(LinkedHashMap<String, List<String>> maps){
