 ...
 * @Date 2020/10/16
 */
public class SearchRzGGZYUtil {
    static String GGZYJYZX_LC_ROOT_URL = "http://ggzyjy.rizhao.gov.cn";
    static String GGZYJYZX_LC_URL = "http://ggzyjy.rizhao.gov.cn/rzwz/showinfo/SearchResult.aspx?" +
            "Eptr3=search_param&Paging=pageIndex_param";

    public static LinkedHashMap<String, List<String>> searchRZGGZYLoop(int bidType, Map<String, List<String>> resultMap){
    ...
    public static List<BidModel> searchRZGGZYDetail(LinkedHashMap<String, List<String>> maps){
